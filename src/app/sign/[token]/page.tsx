    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Document signe !</h1>
        ...
        <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Signature electronique</p>
            </div>
          </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#638BFF] focus:border-transparent"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 space-y-4">
              <label className="flex items-start gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-blue-50/50 transition-colors">
                <input
                  ...
                  className="mt-0.5 w-5 h-5 rounded border-gray-300 text-[#638BFF] focus:ring-[#638BFF]"
                />
                <div>
