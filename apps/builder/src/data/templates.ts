...
export interface PageTemplate {
  ...
  name: string
  description: string
  category: 'saas' | 'agency' | 'ecommerce' | 'portfolio' | 'real-estate' | 'photographe' | 'coiffeur' | 'beaute' | 'agency-models' | 'restaurant' | 'coach' | 'architecte' | 'tatoueur' | 'spa' | 'dj' | 'traiteur' | 'coach-business' | 'yoga' | 'patisserie'
