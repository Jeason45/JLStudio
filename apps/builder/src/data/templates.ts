          ...
          items: [
            {
              ...
              description: 'Un site conçu sur mesure pour refléter votre image avec élégance et performance.',
              image: '/images/jlstudio/services-vitrine.jpg',
              features: JSON.stringify(['Design unique et sur-mesure', 'Animations fluides et immersives', 'Référencement naturel optimisé', 'Adapté à tous les écrans']),
            },
            {
              id: '2',
              icon: '🛒',
              title: 'E-Commerce',
              description: 'Une boutique en ligne pensée pour convertir, de la fiche produit au paiement.',
              image: '/images/jlstudio/services-ecommerce.jpg',
              features: JSON.stringify(['Paiement sécurisé (carte, PayPal)', 'Gestion catalogue et stocks', 'Parcours d\'achat optimisé', 'Tableau de bord des ventes']),
            },
            {
              id: '3',
              icon: '⚡',
              title: 'Applications Web',
              description: 'Des outils métier sur mesure qui simplifient vos processus au quotidien.',
              image: '/images/jlstudio/services-webapp.jpg',
              features: JSON.stringify(['Interface intuitive et moderne', 'Données en temps réel', 'Gestion des accès et permissions', 'Connexion à vos outils existants']),
            },
            {
              id: '4',
              icon: '🎨',
              title: 'Branding Digital',
              description: 'Une identité visuelle forte et cohérente sur tous vos supports digitaux.',
              image: '/images/jlstudio/services-other.jpg',
              features: JSON.stringify(['Identité visuelle complète', 'Charte graphique digitale', 'Iconographie sur-mesure', 'Animations de marque']),
            },
          ],
        },
        style: { background: 'dark' as any, paddingY: 'xl' },
