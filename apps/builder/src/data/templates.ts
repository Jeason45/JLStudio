...

{
  ...
  // ── OPTICIEN — PRISME ──────────────────────────────
  {
    ...
    sections: [
      ...
      { type: 'testimonials', variant: 'prisme-featured', content: { eyebrow: 'Ce que disent nos clients', title: 'Témoignages', items: [{ id: '1', quote: 'Un service d\'exception. L\'opticien a pris le temps de m\'expliquer chaque option et m\'a trouvé la monture parfaite. Mes nouveaux verres progressifs sont d\'une clarté incroyable.', author: 'Catherine L.', role: 'Cliente depuis 12 ans', rating: 5 }, { id: '2', quote: 'Après des années de lunettes inconfortables, j\'ai enfin trouvé mon opticien. Le choix de montures est exceptionnel et le suivi est remarquable.', author: 'Thomas B.', role: 'Porteur de progressifs', rating: 5 }, { id: '3', quote: 'Mon fils avait besoin de lunettes pour la première fois. L\'équipe a été formidable avec lui, patiente et rassurante. Je recommande sans hésiter.', author: 'Marie-Claire D.', role: 'Maman reconnaissante', rating: 5 }] }, style: { background: 'dark' as any, paddingY: 'xl' }, visible: true },
