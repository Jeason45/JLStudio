...
export function FeaturesSection({ config, isEditing }: FeaturesSectionProps) {
  ...
  // ═══════════════════════════════════════════
  // ENCRE — Horizontal Accordion (Tattoo Parlor)
  // ═══════════════════════════════════════════

  if (variant === 'encre-accordion') {
    const [activePanel, setActivePanel] = useState(0)
    ...
    const panelImages = [
      'https://images.unsplash.com/photo-1598371839696-5c5bb00bdc28?w=1200&q=85',
      'https://images.unsplash.com/photo-1542359649-31e03cd4d909?w=1200&q=85',
      'https://images.unsplash.com/photo-1611501275019-9b5cda994e8d?w=1200&q=85',
    ]

    const defaultPanelData = [
      { title: 'Tatouage Custom', description: 'Du concept à la réalisation, chaque pièce est dessinée sur mesure pour s\'adapter parfaitement à votre morphologie et votre histoire.' },
      { title: 'Cover-up', description: 'Transformez un ancien tatouage en une œuvre d\'art nouvelle. Notre expertise en recouvrement garantit un résultat spectaculaire.' },
      { title: 'Flash Tattoo', description: 'Découvrez notre collection de designs originaux prêts à être tatoués. Des pièces uniques à prix fixe, disponibles immédiatement.' },
    ]
    ...
    return (
      ...
      >
        ...
        {/* 3 horizontal accordion panels */}
        <style>{`
          .encre-panel-collapsed:hover { background-color: rgba(10, 10, 10, 0.85) !important; }
          .encre-panel-expanded:hover .encre-panel-img { transform: scale(1.04) !important; }
        `}</style>
        <div
          {...elementProps(config.id, 'panelsRow', 'container', 'Panels Row')}
          className="flex flex-row"
          ...
          {resolvedPanels.map((panel, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'relative overflow-hidden cursor-pointer',
                  isExpanded ? 'encre-panel-expanded' : 'encre-panel-collapsed'
                )}
                style={{
                  flex: isExpanded ? '3 1 0%' : '0.5 1 0%',
                  minHeight: 700,
              ...
              >
                ...
                <img
                  ...
                  src={panel.image}
                  alt={panel.title}
                  className="encre-panel-img absolute inset-0 w-full h-full object-cover"
                  style={{
                    opacity: isExpanded ? 1 : 0,
                    transition: 'opacity 0.7s cubic-bezier(0.4, 0, 0.2, 1), transform 0.7s ease',
                  }}
                ...
                <div
                  ...
                  style={{
                    background: isExpanded
                      ? 'linear-gradient(to top, rgba(10, 10, 10, 0.92) 0%, rgba(10, 10, 10, 0.4) 40%, transparent 70%)'
                      : 'none',
                    zIndex: 1,
                    transition: 'opacity 0.5s ease',
                  }}
                ...
                >
                  ...
                  {/* Crimson glassmorphism arrow button */}
                  <div
                    {...elementProps(config.id, `panels.${i}.arrow`, 'icon', 'Arrow Icon')}
                    style={{
                      width: 48,
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(196, 30, 58, 0.45)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(196, 30, 58, 0.2)' }}
                  >
                    <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="#C41E3A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </div>
              </div>
  ...
  // ═══════════════════════════════════════════
  // SERENITE — Horizontal Accordion (Spa / Beauty Institute)
  // ═══════════════════════════════════════════

  if (variant === 'serenite-accordion') {
    const [activePanel, setActivePanel] = useState(0)
    ...
    const defaultPanelData = [
      { title: 'Soins Visage', description: 'Des protocoles sur mesure utilisant des produits d\'exception pour révéler l\'éclat naturel de votre peau et ralentir les signes du temps.' },
      { title: 'Soins Corps', description: 'Gommages, enveloppements et rituels corporels pensés pour sculpter, hydrater et régénérer votre corps en profondeur.' },
      { title: 'Massages', description: 'Du massage relaxant au deep tissue, nos praticiens certifiés adaptent chaque séance à vos besoins pour une détente absolue.' },
    ]
    ...
    return (
      <section
        ...
        ref={scrollRevealRef}
        className="overflow-hidden"
        style={{ backgroundColor: '#1B1B2F', fontFamily: "'GeneralSans Variable', 'General Sans', sans-serif" }}
      >
        {/* Header area */}
        <div {...elementProps(config.id, 'headerArea', 'container', 'Header Area')} style={{ padding: '0 60px', paddingTop: 'clamp(60px, 10vw, 120px)' }}>
          <div style={{ maxWidth: 1320, margin: '0 auto', textAlign: 'center' }}>
        ...
        {/* 3 horizontal accordion panels */}
        <style>{`
          .serenite-panel-collapsed:hover { background-color: rgba(27, 27, 47, 0.85) !important; }
          .serenite-panel-expanded:hover .serenite-panel-img { transform: scale(1.04) !important; }
        `}</style>
        <div
          {...elementProps(config.id, 'panelsRow', 'container', 'Panels Row')}
          className="flex flex-row"
          ...
          {resolvedPanels.map((panel, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'relative overflow-hidden cursor-pointer',
                  isExpanded ? 'serenite-panel-expanded' : 'serenite-panel-collapsed'
                )}
                style={{
                  flex: isExpanded ? '3 1 0%' : '0.5 1 0%',
                  minHeight: 700,
              ...
              >
                ...
                <img
                  ...
                  src={panel.image}
                  alt={panel.title}
                  className="serenite-panel-img absolute inset-0 w-full h-full object-cover"
                  style={{
                    opacity: isExpanded ? 1 : 0,
                    transition: 'opacity 0.7s cubic-bezier(0.4, 0, 0.2, 1), transform 0.7s ease',
                  }}
                ...
                <div
                  ...
                  style={{
                    background: isExpanded
                      ? 'linear-gradient(to top, rgba(27, 27, 47, 0.92) 0%, rgba(27, 27, 47, 0.4) 40%, transparent 70%)'
                      : 'none',
                    zIndex: 1,
                    transition: 'opacity 0.5s ease',
                  }}
                ...
                >
                  ...
                  <div
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(212, 184, 150, 0.45)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(212, 184, 150, 0.2)' }}
                  >
                    <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="#D4B896" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </div>
              </div>
  ...
  // DJ PULSE — Horizontal Accordion (DJ / Musician)
  // ═══════════════════════════════════════════

  if (variant === 'pulse-accordion') {
    const [activePanel, setActivePanel] = useState(0)
    ...
    const panelImages = [
      'https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=1200&q=85',
      'https://images.unsplash.com/photo-1598653222000-6b7b7a552625?w=1200&q=85',
      'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=1200&q=85',
    ]

    const defaultPanelData = [
      { title: 'DJ Set', description: 'Des sets sur mesure qui fusionnent les genres et enflamment les dancefloors. De la deep house au techno, chaque mix est une expérience unique.' },
      { title: 'Production', description: 'Compositions originales, remixes officiels et sound design. Un studio équipé pour donner vie à vos projets musicaux les plus ambitieux.' },
      { title: 'Live Act', description: 'Performance live avec synthétiseurs, drum machines et effets visuels synchronisés pour une expérience audiovisuelle immersive.' },
    ]
    ...
    return (
      <section
        ...
        ref={scrollRevealRef}
        className="overflow-hidden"
        style={{ backgroundColor: '#0D0D0D', fontFamily: "'GeneralSans Variable', 'General Sans', sans-serif" }}
      >
        {/* Header area */}
        <div {...elementProps(config.id, 'headerArea', 'container', 'Header Area')} style={{ padding: '0 60px', paddingTop: 'clamp(60px, 10vw, 120px)' }}>
          <div style={{ maxWidth: 1320, margin: '0 auto', textAlign: 'center' }}>
        ...
        {/* 3 horizontal accordion panels */}
        <style>{`
          .pulse-panel-collapsed:hover { background-color: rgba(13, 13, 13, 0.85) !important; }
          .pulse-panel-expanded:hover .pulse-panel-img { transform: scale(1.04) !important; }
        `}</style>
        <div
          {...elementProps(config.id, 'panelsRow', 'container', 'Panels Row')}
          className="flex flex-row"
          ...
          {resolvedPanels.map((panel, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'relative overflow-hidden cursor-pointer',
                  isExpanded ? 'pulse-panel-expanded' : 'pulse-panel-collapsed'
                )}
                style={{
                  flex: isExpanded ? '3 1 0%' : '0.5 1 0%',
                  minHeight: 700,
              ...
              >
                ...
                <img
                  ...
                  src={panel.image}
                  alt={panel.title}
                  className="pulse-panel-img absolute inset-0 w-full h-full object-cover"
                  style={{
                    opacity: isExpanded ? 1 : 0,
                    transition: 'opacity 0.7s cubic-bezier(0.4, 0, 0.2, 1), transform 0.7s ease',
                  }}
                ...
                <div
                  ...
                  style={{
                    background: isExpanded
                      ? 'linear-gradient(to top, rgba(13, 13, 13, 0.92) 0%, rgba(13, 13, 13, 0.4) 40%, transparent 70%)'
                      : 'none',
                    zIndex: 1,
                    transition: 'opacity 0.5s ease',
                  }}
                ...
                >
                  ...
                  {/* Magenta glassmorphism arrow button */}
                  <div
                    {...elementProps(config.id, `panels.${i}.arrow`, 'icon', 'Arrow Icon')}
                    style={{
                      width: 48,
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(255, 0, 110, 0.45)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(255, 0, 110, 0.2)' }}
                  >
                    <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="#FF006E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </div>
              </div>
  ...
  // TRAITEUR SAVEUR — Horizontal Accordion (Caterer / Private Chef)
  // ═══════════════════════════════════════════

  if (variant === 'saveur-accordion') {
    const [activePanel, setActivePanel] = useState(0)
    ...
    const panelImages = [
      'https://images.unsplash.com/photo-1530062845289-9109b2c9c868?w=1200&q=85',
    ...
    const defaultPanelData = [
      { title: 'Cocktails & Réceptions', description: 'Des cocktails dînatoires raffinés aux grandes réceptions, nous créons des expériences culinaires mémorables pour vos moments les plus précieux.' },
      { title: 'Repas à domicile', description: 'Votre chef privé s\'installe dans votre cuisine pour un dîner d\'exception. Menu personnalisé, produits frais et service impeccable.' },
      { title: 'Événements d\'entreprise', description: 'Séminaires, lancements de produit, galas : une offre traiteur haut de gamme adaptée à l\'image de votre entreprise.' },
    ]
    ...
    return (
      <section
        ...
        ref={scrollRevealRef}
        className="overflow-hidden"
        style={{ backgroundColor: '#1C1917', fontFamily: "'GeneralSans Variable', 'General Sans', sans-serif" }}
      >
        {/* Header area */}
        <div {...elementProps(config.id, 'headerArea', 'container', 'Header Area')} style={{ padding: '0 60px', paddingTop: 'clamp(60px, 10vw, 120px)' }}>
          <div style={{ maxWidth: 1320, margin: '0 auto', textAlign: 'center' }}>
        ...
        {/* 3 horizontal accordion panels */}
        <style>{`
          .saveur-panel-collapsed:hover { background-color: rgba(28, 25, 23, 0.85) !important; }
          .saveur-panel-expanded:hover .saveur-panel-img { transform: scale(1.04) !important; }
        `}</style>
        <div
          {...elementProps(config.id, 'panelsRow', 'container', 'Panels Row')}
          className="flex flex-row"
          ...
          {resolvedPanels.map((panel, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'relative overflow-hidden cursor-pointer',
                  isExpanded ? 'saveur-panel-expanded' : 'saveur-panel-collapsed'
                )}
                style={{
                  flex: isExpanded ? '3 1 0%' : '0.5 1 0%',
                  minHeight: 700,
              ...
              >
                ...
                <img
                  ...
                  src={panel.image}
                  alt={panel.title}
                  className="saveur-panel-img absolute inset-0 w-full h-full object-cover"
                  style={{
                    opacity: isExpanded ? 1 : 0,
                    transition: 'opacity 0.7s cubic-bezier(0.4, 0, 0.2, 1), transform 0.7s ease',
                  }}
                ...
                <div
                  ...
                  style={{
                    background: isExpanded
                      ? 'linear-gradient(to top, rgba(28, 25, 23, 0.93) 0%, rgba(28, 25, 23, 0.4) 40%, transparent 70%)'
                      : 'none',
                    zIndex: 1,
                    transition: 'opacity 0.5s ease',
                  }}
                ...
                >
                  ...
                  <div
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(200, 169, 126, 0.45)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(200, 169, 126, 0.2)' }}
                  >
                    <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="#C8A97E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </div>
              </div>
  ...
  // ═══════════════════════════════════════════
  // COACH ASCENT — Business / Life Coach Horizontal Accordion
  // ═══════════════════════════════════════════

  if (variant === 'ascent-accordion') {
    const [activePanel, setActivePanel] = useState(0)
    ...
    const panelImages = [
      ...
      'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=1200&q=85',
    ]

    const defaultPanelData = [
      { title: 'Coaching Individuel', description: 'Un accompagnement personnalisé pour clarifier votre vision, dépasser vos blocages et atteindre vos objectifs professionnels et personnels.' },
      { title: 'Coaching d\'Équipe', description: 'Renforcez la cohésion, développez le leadership et alignez votre équipe autour d\'une vision commune pour des résultats exceptionnels.' },
      { title: 'Conférences & Keynotes', description: 'Des interventions inspirantes et percutantes pour motiver vos équipes, transformer les mindsets et impulser le changement.' },
    ]
    ...
    return (
      <section
        ...
        ref={scrollRevealRef}
        className="overflow-hidden"
        style={{ backgroundColor: '#111827', fontFamily: "'GeneralSans Variable', 'General Sans', sans-serif" }}
      >
        {/* Header area */}
        <div {...elementProps(config.id, 'headerArea', 'container', 'Header Area')} style={{ padding: '0 60px', paddingTop: 'clamp(60px, 10vw, 120px)' }}>
          <div style={{ maxWidth: 1320, margin: '0 auto', textAlign: 'center' }}>
        ...
        {/* 3 horizontal accordion panels */}
        <style>{`
          .ascent-panel-collapsed:hover { background-color: rgba(17, 24, 39, 0.85) !important; }
          .ascent-panel-expanded:hover .ascent-panel-img { transform: scale(1.04) !important; }
        `}</style>
        <div
          {...elementProps(config.id, 'panelsRow', 'container', 'Panels Row')}
          className="flex flex-row"
          ...
          {resolvedPanels.map((panel, i) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'relative overflow-hidden cursor-pointer',
                  isExpanded ? 'ascent-panel-expanded' : 'ascent-panel-collapsed'
                )}
                style={{
                  flex: isExpanded ? '3 1 0%' : '0.5 1 0%',
                  minHeight: 700,
              ...
              >
                ...
                <img
                  ...
                  src={panel.image}
                  alt={panel.title}
                  className="ascent-panel-img absolute inset-0 w-full h-full object-cover"
                  style={{
                    opacity: isExpanded ? 1 : 0,
                    transition: 'opacity 0.7s cubic-bezier(0.4, 0, 0.2, 1), transform 0.7s ease',
                  }}
                ...
                <div
                  ...
                  style={{
                    background: isExpanded
                      ? 'linear-gradient(to top, rgba(17, 24, 39, 0.92) 0%, rgba(17, 24, 39, 0.45) 40%, transparent 70%)'
                      : 'none',
                    zIndex: 1,
                    transition: 'opacity 0.5s ease',
                  }}
                ...
                >
                  ...
                  <div
                    ...
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(224, 184, 112, 0.45)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(224, 184, 112, 0.2)' }}
                  >
                    <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3 8h10M9 4l4 4-4 4" stroke="#E0B870" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </div>
              </div>
